...
void fheap_add (fheap_t * f, u32 ni, f64 key)
{
...

  {
    ...
    empty.parent = empty.first_child = empty.next_sibling = empty.prev_sibling = ~0;
    vec_validate_init_empty (f->nodes, ni, empty);
    n = vec_elt_at_index (f->nodes, ni);
